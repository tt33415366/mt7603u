...
typedef struct _SMART_CARRIER_SENSE_CTRL{
	...
	UINT8		SCSStatus; /* 0: Normal, 1:Low gain, 2:Ulta Low gain */
	/*UINT8		SCSStatusAtScan; //0: Normal, 1:Low_gain */
	UINT8		SCSApCountStage1; /* Ap count of RSSI>-50 */
	UINT8		SCSApCountStage2; /* Ap count of -57>=RSSI>-70 */
	UINT8		SCSApCountStage3; /* Ap count of RSSI<=-70 */
	UINT32		SCSTfcThreshold; /* Traffic Threshold */
	UINT32 		ScsOneSecTxOkCnt; /*one second Tx ok count*/
	UINT32 		ScsOneSecTxFailCnt; /*one second Tx Fail count*/
	UINT32		CR_AGC_0_default;
	UINT32		CR_AGC_3_default;
	UINT32		CR_CCK_PD_TH_default;
	UINT8		EDCCA_Status;
	ULONG       GoSmCurrState;/*P2P Go state machine*/
	UINT8		SCSDbgLogLv; /* debug log level */
