	...
	IN  INT Status)
{
	...
	{
#ifdef RELEASE_EXCLUDE
		DBGPRINT(RT_DEBUG_INFO, ("RACFG command(0x%04x)[magic number(0x%08x)] is done\n", 
...
#if defined(MT76x2) || defined(MT7603) || defined(MT7628)
...
#endif /* defined(MT76x2) || defined(MT7603) || defined(MT7628) */
