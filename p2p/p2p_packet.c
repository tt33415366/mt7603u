	...
	IN MLME_QUEUE_ELEM *Elem) 
{
	...
	if (index < MAX_P2P_GROUP_SIZE)
	{
		...
		DBGPRINT(RT_DEBUG_ERROR, ("%s GroupChannel = %d \n", __FUNCTION__, pP2PCtrl->GroupChannel));
		DBGPRINT(RT_DEBUG_TRACE, ("CheckPeerChannelPolicy = %d. bGoUsePeerChannel = %d. INFRA_ON = %d. P2P_GO_ON = %d. P2P_CLI_ON = %d. PeerChannelListNum = %d. PeerChannelIs5GBand = %d\n", 
	...
	IN MLME_QUEUE_ELEM *Elem) 
{
		...
		*/
		...
		if (index < MAX_P2P_GROUP_SIZE)
		{
			...
			DBGPRINT(RT_DEBUG_ERROR, ("%s GroupChannel = %d \n", __FUNCTION__, pP2PCtrl->GroupChannel));
			DBGPRINT(RT_DEBUG_TRACE, ("bConfirmByUI = %d, CheckPeerChannelPolicy = %d. bGoUsePeerChannel = %d. INFRA_ON = %d. P2P_GO_ON = %d. P2P_CLI_ON = %d. PeerChannelListNum = %d. PeerChannelIs5GBand = %d\n", 
